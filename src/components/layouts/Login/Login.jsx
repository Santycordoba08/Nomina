...
const Login = () => {
    ...
    return (
        <div class="container">
            ...
            <p class="bienvenida">Te damos la bienvenida a nuestra solución, el sistema que integra todos los procesos de nómina <br /> y gestión humana en un solo lugar.</p>
