...
//     const proportionalTransportAllowance =
//       (transportAllowance / 30) * daysWorked;
//     const totalSalary =
//       proportionalSalary +
//       proportionalTransportAllowance +
//       parseFloat(salrayextra);
...
//         <p>
//           ¡Calcula tus Prestaciones para {name} {apellidos} (ID: {documento})!
//         </p>
//         <div>
...
//           <select
//             value={hasTransportAllowance}
//             onChange={(e) =>
//               setHasTransportAllowance(e.target.value === "true")
//             }
//           >
...
//             type="number"
//             value={salrayextra}
//             onChange={(e) => setsalrayextra(parseFloat(e.target.value))}
//           />
//         </div>
//         <br />
...
const Liquidacion = () => {
  ...
  const calculate = () => {
    ...
    navigate("/comprobante", { state: { documento } });
  };
